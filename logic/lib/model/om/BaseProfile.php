...
abstract class BaseProfile extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProfilePeer';
	...
	/**
	 * Set the value of [test1] column.
	 * 
	 * @param      string $v new value
	 * @return     Profile The current object (for fluent API support)
	 */
	public function setTest1($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->test1 !== $v) {
			$this->test1 = $v;
			$this->modifiedColumns[] = ProfilePeer::TEST1;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->test1 = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = ProfilePeer::NUM_COLUMNS - ProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setTest1($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilePeer::TEST1)) $criteria->add(ProfilePeer::TEST1, $this->test1);
