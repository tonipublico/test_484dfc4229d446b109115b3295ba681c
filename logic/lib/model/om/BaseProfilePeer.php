...
abstract class BaseProfilePeer {
	...
	/** the column name for the TEST1 field */
	const TEST1 = 'profile.TEST1';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Test1', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'test1', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TEST1, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'test1', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Test1' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'test1' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TEST1 => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'test1' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ProfileMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProfilePeer::TEST1);
    ...
    foreach (sfMixer::getCallables('BaseProfilePeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProfilePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseProfilePeer', $criteria, $con);
    }
...
//
// NOTE: This static code cannot call methods on the ProfilePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ProfilePeer class:
//
// Propel::getDatabaseMap(ProfilePeer::DATABASE_NAME)->addTableBuilder(ProfilePeer::TABLE_NAME, ProfilePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseProfilePeer::DATABASE_NAME)->addTableBuilder(BaseProfilePeer::TABLE_NAME, BaseProfilePeer::getMapBuilder());
